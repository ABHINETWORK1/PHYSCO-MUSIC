...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/611b133991268a6170ad6.png"
        ...
        try:
            ...
            await lel.edit(
                "🧐 **/𝐏𝐋𝐀𝐘 𝐊𝐄 𝐁𝐀𝐃 𝐒𝐎𝐍𝐆🌺 𝐊𝐀 𝐍𝐀𝐌 𝐁𝐇𝐈 𝐋𝐈𝐊𝐇𝐍𝐀 🙄𝐇𝐎𝐓𝐀 𝐇𝐀𝐈🥺🧿🤟...uploaded by @SNEHABHI_SERVER ✨**"
            )
            print(str(e))
            return
        keyboard = InlineKeyboardMarkup(
        ...
        try:
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ __Powered by @SNEHABHI_SERVER__\n\n"
                j += 1
            keyboard = InlineKeyboardMarkup(
                [
                    [
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    # await cb.message.edit("𝙹𝚄𝚂𝚃 𝚆𝙰𝙸𝚃 𝙰 𝚂𝙴𝙲𝙾𝙽𝙳 💫🥺 𝙵𝙾𝚁 𝙿𝙻𝙰𝚈 𝚂𝙾𝙽𝙶 😋❤️...uploaded by @SNEHABHI_SERVER ✨  ♩✌")
    x = int(x)
    try:
